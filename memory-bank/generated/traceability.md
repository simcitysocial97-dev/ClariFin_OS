...
| Property Test | `tests/test_account_engine.py` | ✓ |
...
| Property Test | `tests/properties/test_loan.py` | ✓ |
...
| Golden Dataset | `tests/golden/datasets/cc_statement_scenario.json` | ✓ |
| Golden Dataset | `tests/golden/datasets/salary_plus_loan.json` | ✓ |
| Property Test | `tests/test_financial_events.py` | ✓ |
...
| Layer | Artifact | Status |
|-------|----------|--------|
| Router | `src/routers/behavior.py` | ✓ |
| Router | `src/routers/behaviour.py` | ✓ |
| Service | `src/services/behavior_service.py` | ✓ |
...
| Property Test | `tests/properties/test_behaviour.py` | ✓ |
| Property Test | `tests/properties/behaviour/test_engine_properties.py` | ✓ |
| Invariant | `tests/invariants/test_behaviour.py` | ✓ |
...
|-------|----------|--------|
| Router | `src/routers/financial_intelligence.py` | ✓ |
| Router | `src/routers/scenarios.py` | ✓ |
| Router | `src/routers/goals.py` | ✓ |
...
| Golden Dataset | `tests/golden/datasets/salary_plus_loan.json` | ✓ |
| Golden Dataset | `tests/golden/datasets/irregular_income.json` | ✓ |
| Property Test | `tests/properties/test_forecast.py` | ✓ |
| Property Test | `tests/properties/forecasting/test_engine_properties.py` | ✓ |
| Invariant | `tests/invariants/test_forecast.py` | ✓ |
...
| Golden Dataset | `tests/golden/datasets/salary_plus_loan.json` | ✓ |
| Golden Dataset | `tests/golden/datasets/family_household.json` | ✓ |
| Property Test | `tests/properties/test_cashflow.py` | ✓ |
| Property Test | `tests/properties/cashflow/test_engine_properties.py` | ✓ |
| Invariant | `tests/invariants/test_cashflow.py` | ✓ |
...
| Layer | Artifact | Status |
|-------|----------|--------|
| Router | `src/routers/patterns.py` | ✓ |
...
| Golden Dataset | `tests/golden/datasets/irregular_income.json` | ✓ |
| Golden Dataset | `tests/golden/datasets/normal_household.json` | ✓ |
| Property Test | `tests/test_pattern_repository.py` | ✓ |
| Invariant | `tests/invariants/test_transaction.py` | ✓ |
...
| Layer | Artifact | Status |
|-------|----------|--------|
| Router | `src/routers/optimization.py` | ✓ |
| Service | `src/services/financial_intelligence_service.py` | ✓ |
...
| Golden Dataset | `tests/golden/datasets/high_debt_household.json` | ✓ |
| Golden Dataset | `tests/golden/datasets/credit_card_revolver.json` | ✓ |
| Property Test | `tests/test_recommendation_engine.py` | ✓ |
| Property Test | `tests/test_optimization_engine.py` | ✓ |
| Invariant | `tests/invariants/test_behaviour.py` | ✓ |
...
| Golden Dataset | `tests/golden/datasets/normal_household.json` | ✓ |
| Golden Dataset | `tests/golden/datasets/salary_plus_loan.json` | ✓ |
| Property Test | `tests/test_reconciliation.py` | ✓ |
| Property Test | `tests/test_reconciliation_determinism.py` | ✓ |
| Property Test | `tests/test_reconciliation_stats.py` | ✓ |
| Invariant | `tests/invariants/test_transaction.py` | ✓ |
