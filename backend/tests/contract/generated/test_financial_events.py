...
# Source: POST /api/v1/financial-events/
...
def test_post__api_financial_events__contract(client):
    """Contract: POST /api/v1/financial-events/ matches OpenAPI schema"""

    # TODO: Replace with a valid payload for this endpoint if needed.
    request_body = {}
    response = client.post("/api/v1/financial-events/", json=request_body)
...
# Auto-generated contract test - DO NOT EDIT MANUALLY
# Source: GET /api/v1/financial-events/
...
def test_get__api_financial_events__contract(client):
    """Contract: GET /api/v1/financial-events/ matches OpenAPI schema"""

    response = client.get("/api/v1/financial-events/")
...
# Auto-generated contract test - DO NOT EDIT MANUALLY
# Source: GET /api/v1/financial-events/{event_id}
...
def test_get__api_financial_events_event_id_contract(client):
    """Contract: GET /api/v1/financial-events/{event_id} matches OpenAPI schema"""

    response = client.get("/api/v1/financial-events/1")
