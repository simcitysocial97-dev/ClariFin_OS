...
def test_get_patterns_by_type(pattern_repo):
    ...
    assert impulse_patterns[0]['strength'] >= impulse_patterns[1]['strength']  # Should be sorted by strength
...
def test_household_id_handling(pattern_repo):
    ...
    household_patterns = pattern_repo.get_patterns_by_type('SUBSCRIPTION', 'household_123')
