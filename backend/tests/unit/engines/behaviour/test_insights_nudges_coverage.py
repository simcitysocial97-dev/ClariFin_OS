...
class TestInsightsFullBranchMutants:
    ...
    def test_loss_aversion_velocity(self) -> None:
        p = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "loss_aversion": {"post_income_velocity": 0.51, "large_expense_count": 0},
        }}
    ...
    def test_large_expense_count(self) -> None:
        p = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "loss_aversion": {"post_income_velocity": 0.0, "large_expense_count": 4},
        }}
        insights = generate_behavioral_insights(p)
    ...
    def test_micro_txn_ratio(self) -> None:
        p = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "impulsivity": {**BASE_PROFILE["behavioral_indices"]["impulsivity"],
    ...
    def test_buffer_days_low(self) -> None:
        p = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "financial_stress": {**BASE_PROFILE["behavioral_indices"]["financial_stress"],
                                 "buffer_days": 6},
        }}
    ...
    def test_savings_rate_negative(self) -> None:
        p = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "savings_discipline": {**BASE_PROFILE["behavioral_indices"]["savings_discipline"],
                                   "savings_rate": -0.1},
        }}
    ...
    def test_upi_risk(self) -> None:
        p = {**BASE_PROFILE, "risk_signals": {"india_specific": {"upi_micro_spend_flag": True}}}
        assert "UPI Micro-Spend Clustering" in _titles(generate_behavioral_insights(p))

    def test_gambling_risk(self) -> None:
        p = {**BASE_PROFILE, "risk_signals": {
            "india_specific": {"gambling_flag": True, "gambling_transaction_count": 2}}}
        assert "Gaming/Gambling Transactions" in _titles(generate_behavioral_insights(p))

    def test_loan_app_risk(self) -> None:
        p = {**BASE_PROFILE, "risk_signals": {"india_specific": {"loan_app_pattern_flag": True}}}
    ...
    def test_health_low(self) -> None:
        ...
        assert "Financial Health Needs Attention" in _titles(generate_behavioral_insights(p))
...
class TestInsightsSummaryTextMutants:
    ...
    def test_impulse_high(self) -> None:
        p = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "impulsivity": {**BASE_PROFILE["behavioral_indices"]["impulsivity"], "score": 0.8},
        }}
    ...
    def test_impulse_low(self) -> None:
        p = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "impulsivity": {**BASE_PROFILE["behavioral_indices"]["impulsivity"], "score": 0.2},
        }}
...
class TestNudgesFullBranchMutants:
    ...
    def test_impulse_high(self) -> None:
        p = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "impulsivity": {**BASE_PROFILE["behavioral_indices"]["impulsivity"], "score": 0.71},
        }}
    ...
    def test_velocity(self) -> None:
        p = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "loss_aversion": {"post_income_velocity": 0.61, "large_expense_count": 0},
        }}
    ...
    def test_gambling_risk(self) -> None:
        p = {**BASE_PROFILE, "risk_signals": {"india_specific": {"gambling_flag": True}}}
    ...
    def test_exact_nudge_keys(self) -> None:
        ...
        assert set(n.keys()) == {"type", "priority", "title", "message", "trigger", "actionable"}
...
class TestNudgesBoundaryExactMutants:
    def test_impulse_score_boundary(self) -> None:
        ...
        p = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "impulsivity": {**BASE_PROFILE["behavioral_indices"]["impulsivity"], "score": 0.7},
        }}
        assert "Implement 24-Hour Rule" not in _titles(generate_nudges(p))
        p2 = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "impulsivity": {**BASE_PROFILE["behavioral_indices"]["impulsivity"], "score": 0.7001},
        }}
    ...
    def test_velocity_boundary(self) -> None:
        ...
        p2 = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "loss_aversion": {"post_income_velocity": 0.6001, "large_expense_count": 0},
        }}
    ...
    def test_savings_high_boundary(self) -> None:
        ...
        p = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "savings_discipline": {**BASE_PROFILE["behavioral_indices"]["savings_discipline"],
                                   "score": 0.7, "savings_rate": 0.5},
            "impulsivity": {**BASE_PROFILE["behavioral_indices"]["impulsivity"],
                           "score": 0.0, "micro_txn_ratio": 0.0},
            "habit_stability": {"category_cv": 0.0, "recurring_count": 5},
            "financial_stress": {**BASE_PROFILE["behavioral_indices"]["financial_stress"],
                                "score": 0.0, "buffer_days": 30},
    ...
    def test_emi_boundary(self) -> None:
        ...
        p = {**BASE_PROFILE, "risk_signals": {"india_specific": {"emi_ratio": 0.5}},
             "behavioral_indices": {
                 **BASE_PROFILE["behavioral_indices"],
                 "savings_discipline": {**BASE_PROFILE["behavioral_indices"]["savings_discipline"],
                                       "score": 0.6, "savings_rate": 0.5},
                 "impulsivity": {**BASE_PROFILE["behavioral_indices"]["impulsivity"],
                                "score": 0.0, "micro_txn_ratio": 0.0},
                 "habit_stability": {"category_cv": 0.0, "recurring_count": 5},
                 "financial_stress": {**BASE_PROFILE["behavioral_indices"]["financial_stress"],
        ...
        p2 = {**BASE_PROFILE, "risk_signals": {"india_specific": {"emi_ratio": 0.5001}},
              "behavioral_indices": {
                  **BASE_PROFILE["behavioral_indices"],
                  "savings_discipline": {**BASE_PROFILE["behavioral_indices"]["savings_discipline"],
                                        "score": 0.6, "savings_rate": 0.5},
    ...
    def test_get_top_nudge_exact(self) -> None:
        ...
        top = get_top_nudge(p)
        assert set(top.keys()) == {"type", "priority", "title", "message", "trigger", "actionable"}
...
class TestNudgeHelpersMutants:
    ...
    def _single_nudge_profile(self) -> dict:
        return {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "impulsivity": {**BASE_PROFILE["behavioral_indices"]["impulsivity"],
                            "score": 0.71},
            "savings_discipline": {**BASE_PROFILE["behavioral_indices"]["savings_discipline"],
                                   "score": 0.5, "savings_rate": 0.5},
            "habit_stability": {"category_cv": 0.0, "recurring_count": 5},
        }}
...
class TestInsightsBoundaryExactMutants:
    ...
    def test_velocity_exact_boundary(self) -> None:
        ...
        p = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "loss_aversion": {"post_income_velocity": 0.5, "large_expense_count": 0},
        }}
        insights = generate_behavioral_insights(p)
        ...
        p2 = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "loss_aversion": {"post_income_velocity": 0.5001, "large_expense_count": 0},
        }}
    ...
    def test_large_expense_exact_boundary(self) -> None:
        ...
        p = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "loss_aversion": {"post_income_velocity": 0.0, "large_expense_count": 3},
        }}
    ...
    def test_micro_ratio_exact_boundary(self) -> None:
        ...
        assert "High Micro-Transaction Rate" not in _titles(generate_behavioral_insights(p))
        p2 = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "impulsivity": {**BASE_PROFILE["behavioral_indices"]["impulsivity"],
                            "micro_txn_ratio": 0.4001},
        }}
        assert "High Micro-Transaction Rate" in _titles(generate_behavioral_insights(p2))
    ...
    def test_weekend_ratio_exact_boundary(self) -> None:
        ...
        assert "Weekend Spending Premium" not in _titles(generate_behavioral_insights(p))
        p2 = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "impulsivity": {**BASE_PROFILE["behavioral_indices"]["impulsivity"],
                            "weekend_ratio": 1.301},
    ...
    def test_discretionary_exact_boundary(self) -> None:
        ...
        assert "High Discretionary Spending" not in _titles(generate_behavioral_insights(p))
        p2 = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "impulsivity": {**BASE_PROFILE["behavioral_indices"]["impulsivity"],
                            "discretionary_ratio": 0.4001},
        }}
        assert "High Discretionary Spending" in _titles(generate_behavioral_insights(p2))

    def test_category_cv_both_branches(self) -> None:
        # > 0.5 triggers warning; < 0.2 triggers positive; between is silent
        p_high = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "habit_stability": {"category_cv": 0.5001, "recurring_count": 0},
        }}
        assert "Unstable Spending Patterns" in _titles(generate_behavioral_insights(p_high))
        p_low = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "habit_stability": {"category_cv": 0.1999, "recurring_count": 0},
        }}
        assert "Consistent Spending Habits" in _titles(generate_behavioral_insights(p_low))
        p_mid = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
    ...
    def test_recurring_boundary(self) -> None:
        ...
        assert "Strong Recurring Pattern" not in _titles(generate_behavioral_insights(p2))

    def test_buffer_days_both_branches(self) -> None:
        # < 7 warning; > 30 positive
        p_low = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "financial_stress": {"buffer_days": 6.9, "credit_dependency": 0.0,
                                "eom_depletion_ratio": 0.0, "score": 0.0},
        }}
        assert "Low Financial Buffer" in _titles(generate_behavioral_insights(p_low))
        p_high = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "financial_stress": {"buffer_days": 30.1, "credit_dependency": 0.0,
                                "eom_depletion_ratio": 0.0, "score": 0.0},
        }}
        assert "Healthy Financial Buffer" in _titles(generate_behavioral_insights(p_high))

    def test_credit_dependency_boundary(self) -> None:
        # > 1.2 boundary
        p = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "financial_stress": {"buffer_days": 30, "credit_dependency": 1.2,
                                "eom_depletion_ratio": 0.0, "score": 0.0},
        }}
        assert "High Credit Dependency" not in _titles(generate_behavioral_insights(p))
        p2 = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "financial_stress": {"buffer_days": 30, "credit_dependency": 1.2001,
                                "eom_depletion_ratio": 0.0, "score": 0.0},
        }}
    ...
    def test_eom_ratio_boundary(self) -> None:
        ...
        p = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "financial_stress": {"buffer_days": 30, "credit_dependency": 0.0,
                                "eom_depletion_ratio": 0.25, "score": 0.0},
        }}
        assert "End-of-Month Depletion" not in _titles(generate_behavioral_insights(p))
        p2 = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "financial_stress": {"buffer_days": 30, "credit_dependency": 0.0,
                                "eom_depletion_ratio": 0.2501, "score": 0.0},
        }}
    ...
    def test_savings_rate_branches(self) -> None:
        ...
        p_neg = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "savings_discipline": {"savings_rate": -0.0001, "momentum": 0.0,
                                   "consistency": 0.0, "score": 0.0},
        }}
        assert "Negative Savings Rate" in _titles(generate_behavioral_insights(p_neg))
        p_pos = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "savings_discipline": {"savings_rate": 0.2001, "momentum": 0.0,
                                   "consistency": 0.0, "score": 0.0},
        }}
    ...
    def test_momentum_branches(self) -> None:
        ...
        p_dec = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "savings_discipline": {"savings_rate": 0.0, "momentum": -0.1001,
                                   "consistency": 0.0, "score": 0.0},
        }}
        assert "Declining Savings Trend" in _titles(generate_behavioral_insights(p_dec))
        p_inc = {**BASE_PROFILE, "behavioral_indices": {
            **BASE_PROFILE["behavioral_indices"],
            "savings_discipline": {"savings_rate": 0.0, "momentum": 0.1001,
                                   "consistency": 0.0, "score": 0.0},
        }}
    ...
    def test_temporal_branches(self) -> None:
        ...
        p_up = {**BASE_PROFILE, "temporal_patterns": {"trend": 0.1001, "volatility": 0.0}}
        assert "Upward Spending Trend" in _titles(generate_behavioral_insights(p_up))
        p_down = {**BASE_PROFILE, "temporal_patterns": {"trend": -0.1001, "volatility": 0.0}}
        assert "Downward Spending Trend" in _titles(generate_behavioral_insights(p_down))
        # volatility > 0.8
        p_vol = {**BASE_PROFILE, "temporal_patterns": {"trend": 0.0, "volatility": 0.8001}}
        assert "High Spending Volatility" in _titles(generate_behavioral_insights(p_vol))

    def test_health_score_branches(self) -> None:
        p_high = {**BASE_PROFILE, "financial_health_score": 70}
        assert "Strong Financial Health" in _titles(generate_behavioral_insights(p_high))
        p_low = {**BASE_PROFILE, "financial_health_score": 39.9}
        assert "Financial Health Needs Attention" in _titles(generate_behavioral_insights(p_low))
    ...
    def test_confidence_boundary(self) -> None:
        ...
        assert "Limited Data for Analysis" not in _titles(generate_behavioral_insights(p2))
