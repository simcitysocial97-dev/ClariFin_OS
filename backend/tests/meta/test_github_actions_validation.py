...
class TestGitHubActionsValidation:
    ...
    def test_workflow_has_detect_changes_job(self) -> None:
        ...
        assert "detect-changes" in jobs, (
            "Workflow missing 'detect-changes' job"
        )
    ...
    def test_workflow_has_intelligence_analysis_job(self) -> None:
        ...
        workflow = _load_workflow()
        jobs = workflow.get("jobs", {})
        assert "intelligence-analysis" in jobs, (
    ...
    def test_workflow_has_property_tests_job(self) -> None:
        ...
        assert "property-tests" in jobs, (
            "Workflow missing 'property-tests' job"
        )
    ...
    def test_workflow_has_contract_tests_job(self) -> None:
        ...
        workflow = _load_workflow()
        jobs = workflow.get("jobs", {})
        assert "contract-tests" in jobs, (
            "Workflow missing 'contract-tests' job"
        )
    ...
    def test_workflow_has_capability_tests_job(self) -> None:
        ...
        workflow = _load_workflow()
        jobs = workflow.get("jobs", {})
        assert "capability-tests" in jobs, (
            "Workflow missing 'capability-tests' job"
        )
    ...
    def test_workflow_has_invariant_tests_job(self) -> None:
        ...
        workflow = _load_workflow()
        jobs = workflow.get("jobs", {})
        assert "invariant-tests" in jobs, (
            "Workflow missing 'invariant-tests' job"
        )
    ...
    def test_workflow_jobs_use_intelligence_outputs(self) -> None:
        ...
        for job_name in test_jobs:
            ...
            assert "intelligence-analysis" in if_condition or job_name in str(if_condition) or not if_condition, (
    ...
    def test_workflow_has_concurrency_control(self) -> None:
        ...
        assert concurrency, (
            "Workflow missing 'concurrency' control"
        )
    ...
    def test_workflow_has_timeouts(self) -> None:
        ...
        for job_name in test_jobs:
            ...
            assert timeout > 0, (
                f"Job {job_name} missing timeout"
            )
            assert timeout <= 30, (
                f"Job {job_name} timeout too long: {timeout} minutes"
            )
    ...
    def test_workflow_has_determinism_check(self) -> None:
        ...
        workflow = _load_workflow()
        jobs = workflow.get("jobs", {})
        assert "determinism-check" in jobs, (
            "Workflow missing 'determinism-check' job"
        )
...
- [x] Part H: GitHub Actions Validation (test_github_actions_validation.py)
