...
class AlertRepository(BaseRepository):
    ...
    def get_active_alerts(self, household_id: str | None = None) -> list[dict[str, Any]]:
    ...
    def get_alerts_by_type(self, alert_type: str, household_id: str | None = None) -> list[dict[str, Any]]:
        """Get alerts by type."""
        household_id = household_id or 'default'
        with self._get_conn() as conn:
            rows = conn.execute("""
            ...
            """, (household_id, alert_type)).fetchall()
