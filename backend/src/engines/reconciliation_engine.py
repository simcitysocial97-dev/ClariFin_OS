...
def _parse_date_iso(date_iso: str) -> Optional[datetime]:
...
def _date_difference_days(date_a: str, date_b: str) -> Optional[int]:
    """
...
def _check_match(txn_a: Dict, txn_b: Dict, max_date_window_days: int = 3) -> Optional[Dict]:
    """
