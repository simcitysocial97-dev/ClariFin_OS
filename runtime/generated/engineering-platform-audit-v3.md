...
**Generated:** 2026-08-06T13:17:31.393327+00:00
**Overall Status:** pass
...
- [PASS] Performance: status: status completed in 0.212s
- [PASS] Performance: metrics: metrics completed in 0.229s
- [PASS] Performance: history: history completed in 0.159s
- [PASS] Performance: verify-status: verify-status completed in 0.162s
- [PASS] Performance: integrity: integrity completed in 1.111s
- [PASS] Performance summary: Avg: 0.375s, Min: 0.159s, Max: 1.111s
...
- [PASS] Command 'diagnose' produces output: 'diagnose' produced 1192 bytes of output
- [PASS] Command 'affected' exit code: 'affected' returned exit code 0
- [PASS] Command 'affected' produces output: 'affected' produced 32 bytes of output
- [PASS] Command 'repair' exit code: 'repair' returned exit code 0
- [PASS] Command 'repair' produces output: 'repair' produced 40 bytes of output
- [PASS] Command 'risk' exit code: 'risk' returned exit code 0
- [PASS] Command 'risk' produces output: 'risk' produced 66 bytes of output
...
- **cache_has_data:** True
- **planner_generated_plan_id:** plan-20260806-131729
- **planner_scope:** quick
...
- **artifacts_with_consumers:** 91
- **artifacts_without_consumers:** 0

- [PASS] All artifacts have registered owners: All 91 artifacts in runtime/generated/ have registered owners
- [PASS] No artifact overwrites detected: All artifact names in runtime/generated/ are unique
- [PASS] All artifacts have retention policies: All 91 artifacts have defined retention policies
- [PASS] No duplicate artifact content detected: All artifacts in runtime/generated/ have unique content
- [PASS] Artifact consumption tracking complete: All 91 artifacts have registered consumers
- [PASS] Workflow artifact references checked: Checked 9 workflow files for artifact references; 11 artifacts are referenced
- [PASS] All artifacts have registered consumers: All 91 artifacts have registered consumers
...
- **planner_target_count:** 1
- **planner_estimated_duration:** 3600
- **graph_load_duration_seconds:** 0.113
- **graph_statistics_duration_seconds:** 0.0018
- **graph_node_count:** 0
- **graph_edge_count:** 0
- **knowledge_query_count:** 9
- **knowledge_successful_queries:** 9
- **knowledge_total_duration_seconds:** 0.0217
...
- **integrity_check_duration_seconds:** 1.1853
...
- **diagnostics_diagnose_duration_seconds:** 0.0001
- **diagnostics_total_duration_seconds:** 0.0001
- **github_workflow_files_count:** 9
- **github_parse_verification-runtime_duration_seconds:** 0.0071
- **github_parse_quality_duration_seconds:** 0.005
- **github_parse_golden_duration_seconds:** 0.005
- **github_parse_dependency-update_duration_seconds:** 0.0052
- **github_parse_backend-verify_duration_seconds:** 0.0052
- **github_parse_release_duration_seconds:** 0.004
- **github_parse_playwright_duration_seconds:** 0.0074
- **github_parse_mutation_duration_seconds:** 0.0056
- **github_parse_frontend-verify_duration_seconds:** 0.006
- **github_total_parse_duration_seconds:** 0.0505

- [PASS] Planner performance is acceptable: Planner completed in 0.0002s
- [PASS] Graph loading performance is acceptable: Graph loaded in 0.1130s with 0 nodes
- [PASS] Knowledge lookup performance is acceptable: Knowledge lookups completed in 0.0217s (9/9 successful)
- [PASS] Workspace rendering performance is acceptable: Workspace rendering completed in 0.0000s
- [PASS] Integrity check performance is acceptable: Integrity checks completed in 1.1853s with 0 violations
- [PASS] Diagnostics performance is acceptable: Diagnostics completed in 0.0001s
- [PASS] GitHub parsing performance is acceptable: GitHub workflow parsing completed in 0.0505s for 9 files
...
- **pipeline_total_duration_seconds:** 0.0178
- **pipeline_results:** [{'stage': 'git_change', 'name': 'Git Change Detection', 'status': 'pass', 'duration_seconds': 0.0102, 'findings_count': 1}, {'stage': 'planner', 'name': 'Verification Planner', 'status': 'pass', 'duration_seconds': 0.0002, 'findings_count': 1}, {'stage': 'tests_selected', 'name': 'Test Selection', 'status': 'pass', 'duration_seconds': 0.0, 'findings_count': 1}, {'stage': 'executor', 'name': 'Test Executor', 'status': 'pass', 'duration_seconds': 0.0001, 'findings_count': 1}, {'stage': 'results', 'name': 'Results Collection', 'status': 'pass', 'duration_seconds': 0.0001, 'findings_count': 1}, {'stage': 'evidence', 'name': 'Evidence Aggregation', 'status': 'pass', 'duration_seconds': 0.001, 'findings_count': 1}, {'stage': 'knowledge', 'name': 'Knowledge Indexing', 'status': 'pass', 'duration_seconds': 0.0024, 'findings_count': 1}, {'stage': 'workspace', 'name': 'Workspace Rendering', 'status': 'pass', 'duration_seconds': 0.0014, 'findings_count': 1}, {'stage': 'dashboard', 'name': 'Dashboard Generation', 'status': 'pass', 'duration_seconds': 0.0002, 'findings_count': 1}, {'stage': 'github', 'name': 'GitHub Reporting', 'status': 'pass', 'duration_seconds': 0.0001, 'findings_count': 1}, {'stage': 'artifact', 'name': 'Artifact Management', 'status': 'pass', 'duration_seconds': 0.0021, 'findings_count': 1}, {'stage': 'status', 'name': 'Status Reporting', 'status': 'pass', 'duration_seconds': 0.0, 'findings_count': 1}]
- **pipeline_trace_complete:** True
- **pipeline_stages_traced:** 12

- [PASS] Git change detection stage passed: Git is available and 25 changed files detected
- [PASS] Planner stage passed: Planner generated plan plan-20260806-131730 with 1 steps and 1 targets
...
- [PASS] Artifact management stage passed: Artifact directory exists with 91 files
...
- **manual_inspection:** {'total_python_files': 6197, 'backend_python_files': 5967, 'runtime_python_files': 184, 'manual_inspection_time_per_file_seconds': 120.0, 'manual_inspection_total_time_seconds': 743640.0}
