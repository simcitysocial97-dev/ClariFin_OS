...
def _build_additional_patterns() -> dict[str, CommandSemantics]:
    ...
    extras = {
        ...
        "runtime.verify playwright": _sem(
            "e2e",
            "task::e2e::playwright",
            "e2e-evidence",
            "observational",
