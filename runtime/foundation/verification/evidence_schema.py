"""
M9-C55 — Unified Evidence Schema.

Single source of truth for all verification evidence dataclasses.
Consolidates evidence models previously scattered across:
  - runtime/system/evidence/models/evidence.py
  - runtime/foundation/verification/models/model.py (VerificationEvidence only)

All public names remain importable from their original locations via
...
Module map::
    ...
    test_results    — TestResultEvidence
...
# ---------------------------------------------------------------------------
# Verification evidence (artifact-level, from system/evidence)
# ---------------------------------------------------------------------------
