...
COMMAND_MATCHERS: tuple[tuple[str, CommandSemantics], ...] = (
    ...
    # Canonical module-form variants (python -m runtime.verify <profile>)
    (
    ...
    (
        "python -m runtime.verify mutation --target",
        _sem(
            "mutation",
            "task::mutation::targeted",
            "mutation-summary",
    ...
    (
        "python -m runtime.verify mutation",
        _sem(
            "mutation",
            "task::mutation::full",
            "mutation-summary",
    ...
    (
        "python -m runtime.verify backend",
        _sem(
            "unit",
            "task::unit::backend-suite",
            "test-report",
    ...
    (
        "python -m runtime.verify status",
        _sem(
            "static",
            "task::static::status-summary",
            "status-summary",
    ...
    # Additional verify profiles used by workflows
    (
        "python -m runtime.verify api-contracts",
        _sem(
            "contract",
            "task::contract::api",
            "contract-evidence",
    ...
    (
        "python -m runtime.verify golden",
        _sem(
            "golden",
            "task::golden::regression",
            "golden",
    ...
    (
        "python -m runtime.verify playwright",
        _sem(
            "e2e",
            "task::e2e::playwright",
            "test-report",
            ...
            "surface_only",
            False,
            "Playwright E2E interaction verification",
        ),
    ),
    (
    ...
    (
        "python -m runtime.verify runtime",
        _sem(
            "static",
            "task::static::runtime-check",
            "runtime-fingerprint",
            "observational",
            False,
            "infra_health",
            False,
            "engineering runtime health verification",
        ),
    ),
)
