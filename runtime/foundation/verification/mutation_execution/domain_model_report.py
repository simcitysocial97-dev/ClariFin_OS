...
def build_domain_model_report() -> dict:
    return {
        ...
        "mutation_campaign_fields": [
            "campaign_id", "repository_revision", "environment_fingerprint",
            "mutation_backend", "backend_version", "scope", "test_selection",
            "configuration_fingerprint", "execution_policy", "creation_timestamp",
            "status", "resumed_from", "worker_count", "shard_index", "shard_total",
        ],
        "mutation_candidate_fields": [
            "canonical_mutant_id", "source_file", "source_hash", "function",
            "line", "column", "operator", "original_expression", "mutated_expression",
            "capability", "component", "risk", "selected_tests", "backend_metadata",
        ],
        "mutation_execution_fields": [
            "execution_id", "campaign_id", "mutant_id", "worker_id",
            "start_time", "end_time", "duration_seconds", "process_id",
            "exit_status", "test_result", "timeout", "infrastructure_failure",
            "mutation_result", "stdout_ref", "stderr_ref", "retry_count",
            "workspace_id", "verification_passed",
        ],
        "mutation_result_fields": [
            "campaign_id", "total_candidates", "killed", "survived", "equivalent",
            "no_tests", "timeout", "execution_error", "invalid_mutant",
            "not_executed", "cancelled", "unknown",
            "total_executions", "successful_executions", "infrastructure_failures",
            "timeouts", "retries_total",
        ],
