    ...
    def _register_workflows(self) -> None:
        ...
        default_workflows = {
            ...
            "frontend": VerificationWorkflow(
                ...
                command=".github/scripts/run_frontend_verification.sh",
            ...
            "property": VerificationWorkflow(
                ...
                command=".github/scripts/run_property_tests.sh",
                estimated_duration_seconds=300,
            ...
            "integration": VerificationWorkflow(
                ...
                command=".github/scripts/run_integration_tests.sh",
                estimated_duration_seconds=600,
            ...
            "migration": VerificationWorkflow(
                ...
                command=".github/scripts/run_migration_verification.sh",
            ...
            "repository": VerificationWorkflow(
                ...
                command=".github/scripts/run_full_verification.sh",
