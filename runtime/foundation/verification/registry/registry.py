...
class VerificationRegistry:
    ...
    def _register_workflows(self) -> None:
        ...
        default_workflows = {
            ...
            "api-contracts": VerificationWorkflow(
                id="api-contracts",
                name="API Contract Integrity Gate",
                description="M9-C27 — API Contract Integrity & Drift-Proofing. Detects DTO/Zod/endpoint/openapi drift before E2E.",
                category=VerificationCategory.CONTRACT,
                scope=VerificationScope.CONTRACTS,
                command="bash .github/scripts/run_api_contracts.sh",
    ...
    def _register_scripts(self) -> None:
        ...
        default_scripts = {
            ...
            "run_api_contracts": VerificationScript(
                id="run_api_contracts",
                name="API Contract Integrity Gate",
                path=".github/scripts/run_api_contracts.sh",
    ...
    def _register_capabilities(self) -> None:
        ...
        default_capabilities = {
            ...
            "reconciliation": VerificationCapability(
                ...
                requirements=[
                    VerificationRequirement(
                        ...
                        scope=VerificationScope.PROPERTY,
                        module="backend/src/engines/reconciliation_engine.py",
            ...
            "ledger": VerificationCapability(
                ...
                requirements=[
                    VerificationRequirement(
                        ...
                        scope=VerificationScope.CONTRACTS,
                        module="backend/src/engines/ledger_audit_engine.py",
                        capability="ledger",
                    ),
                    VerificationRequirement(
                        id="ledger-contract",
            ...
            "api-contracts": VerificationCapability(
                ...
                workflows=["api-contracts", "contracts", "frontend", "backend"],
                scripts=[
                    "run_api_contracts",
                    "run_contract_tests",
                ...
                modules=["backend/src", "frontend/src", "frontend/lib", "frontend/types"],
            ),
