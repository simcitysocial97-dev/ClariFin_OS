...
def render_status(workspace: StatusWorkspace) -> str:
    ...
    lines.append(render_table(
        ["Field", "Value"],
        [
            ["Avg Duration", format_duration(workspace.planner.avg_duration_seconds)],
    ...
    lines.append(render_table(
        ...
        [
            ...
            ["Verification Success Rate", format_percent(workspace.health.verification_success_rate)],
            ["Local Success Rate", format_percent(workspace.health.local_success_rate)],
            ...
            ["Avg Duration", format_duration(workspace.health.avg_duration_seconds)],
        ],
    ))
    ...
    lines.append(render_table(
        ...
        [
            ...
            ["Executed Profiles", ", ".join(workspace.cache.executed_profiles) or "none"],
