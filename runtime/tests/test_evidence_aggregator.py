...
class TestEvidenceAggregator:
    ...
    def test_dependency_chain_lookup_by_test_name(self):
        ...
        result = _find_dependency_chain(
            "useloanscapability.contract.test.ts", cross_map
        )
    ...
    def test_dependency_chain_formatting_in_report(self, tmp_path: Path):
        ...
        with patch("runtime.system.evidence.aggregator.CROSS_LAYER_MAP_PATH", map_path):
    ...
    def test_aggregate_with_synthetic_failing_tests(self, tmp_path: Path):
        ...
        tc1 = ET.SubElement(
            root,
            "testcase",
            name="useloanscapability.contract.test.ts",
            classname="test",
            time="0.05",
        )
