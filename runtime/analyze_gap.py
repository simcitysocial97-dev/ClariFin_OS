...
def build():
    ...
    old = {
        ...
        "passing_sections": ["Repository Index", "Dependency Graph", "Verification Planner",
                              "Executor", "Evidence Aggregator", "Observability", "Knowledge Base (structure)",
                              "Workspace", "Integrity Engine", "GitHub Actions", "Runtime CLI",
                              "GitHub Runtime", "Verification Profiles"],
    }
    ...
    analysis = {
        ...
        "q6_lazy_imports_and_top_level_placement": {
            "top_level_files_outside_packages": [
                "backend/src/engines/balance_engine.py", "backend/src/engines/ledger_audit_engine.py",
                "backend/src/engines/nudge_engine.py", "backend/src/engines/reconciliation_engine.py",
                "backend/src/engines/insight_generator.py", "backend/src/engines/behavior_engine.py (parked)",
            ],
    ...
    print(f"  disappeared: {len(disappeared)}  remaining: {len(remaining)}  "
