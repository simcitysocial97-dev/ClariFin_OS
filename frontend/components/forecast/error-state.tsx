/**
 * Forecast Error State - Stage 4 Forecast Intelligence Workspace
 *
 * Error state components for forecast workspace.
 *
...
/**
 * Forecast Error State Component
 */
